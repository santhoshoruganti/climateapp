...
class WeatherSummary {
	...
	WeatherSummary(String searchedCity, Weather weather) {
		...
		this.humidity=Float.toString(weather.getHumidity());
		this.pressure=Float.toString(weather.getPressure());
		System.out.println("Pressure Value is "+weather.getPressure());
